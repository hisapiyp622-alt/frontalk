 ...
 *
 * ★ 受付終了・提供終了の伝えかた（1.152.0〜・製品化レビュー 4-11）
 *   このファイルから項目を消しても、店舗の料金表には残り続けます（消したことは
 *   伝わりません）。受付が終わったものは、必ず終了日を書いて伝えてください。
 *
 *     { "id": "u22", "name": "ドコモU22割", …, "retiredFrom": "2026-12-01" }
 *
 *   ・retiredFrom … その日から「新しくは選べなくなる」日（YYYY-MM-DD）。
 *     すでに終わっているものは、配る日の日付を入れる。
 *   ・その日が来ると、見積もり画面の一覧から自動で外れます。
 ...
 *   お客様が読む一文が入ります（お手元に残る紙に書かれます）。
 *
 *     { "id": "poikatsu_max", …,
 *       "revise": { "from": "2026-12-01", "text": "2026年12月のご利用分から…" } }
 *
 *   ・from … 改定が始まる日（YYYY-MM-DD）。その日より前だけ「予告」として出る。
 *     日が来たら自動で出なくなるので、そのときまでに計算のほうを直すこと。
 *   ・text … お客様が読む一文。専門用語は使わず、何がどう変わるかを短く。
 *   ・書ける場所: plans / voiceOptions / options / feeItems / campaigns
 *   ・予告を配るときも masterVersion を +1 する（上げないと誰にも届きません）。
...
const DEFAULT_DATA = {
  ...
  "plans": [
    ...
    },
    {
      ...
      "revise": {
        "from": "2026-12-01",
        "text": "このお見積もりのdポイント（ご利用料金分）は、2026年12月のご利用分から適用される計算でご案内しています。ポイ活の特典としてお受け取りになったポイントぶんを差し引いた金額が対象になる計算です。2026年11月のご利用分までは差し引かないため、実際にはこのお見積もりより多くたまります。"
      },
      "maxBonus": true
    },
    {
    ...
    },
    {
      ...
      "includes5min": false,
      "dcard10": false,
      "note": "法人名義のプラン（5G）。指定ISPサービス（spモード分330円）込み。3段階制・無制限。社員間通話は無料。海外ローミング30GB/15日込み。ビジネスメンバーズ割▲275円/月（ドコモビジネスメンバーズへの加入が条件）、社員割▲275円/月（同一「ビジネス通話割引」グループ内の音声回線が6回線以上・2in1とirumo 0.5GBは除く）。dカードお支払割・dカードGOLD/PLATINUMの利用料金還元は対象外。",
      "bakuageTier": "",
      "poikatsuPt": 0,
      "maxBonus": false
    },
    {
      ...
      "note": "法人名義のプラン（5G）。指定ISPサービス（spモード分330円）込み。国内通話無料がプランに含まれるため、通話オプションは不要です（選んでも0円）。データ量は2GBで、超えると最大128kbps。ビジネスメンバーズ割▲275円/月（ドコモビジネスメンバーズへの加入が条件）。社員割は提供条件書に記載がないため対象外です。みんなドコモ割・セット割・dカードお支払割も対象外。",
      "bakuageTier": "",
      "poikatsuPt": 0,
      "maxBonus": false
    },
